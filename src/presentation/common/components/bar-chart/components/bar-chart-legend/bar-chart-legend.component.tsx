...
import { BarChartLegendProps, BarChartLegendItemProps } from '@/presentation/common/components'
import { BarLegendCircle, BarLegendText } from '@/presentation/common/components/bar-chart/components/bar-chart-legend/styles'
